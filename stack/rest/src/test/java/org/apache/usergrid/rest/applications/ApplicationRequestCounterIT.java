...
public class ApplicationRequestCounterIT extends AbstractRestIT {
    ...
    public void applicationrequestInternalCounters() throws Exception {
        // Get application id
        JsonNode node = resource().path( "/org.apache.usergrid.test-organization/org.apache.usergrid.test-app" ).queryParam( "access_token", access_token )
        ...
        // call
        node = resource().path( "/org.apache.usergrid.test-organization/org.apache.usergrid.test-app/counters" ).queryParam( "resolution", "all" )
